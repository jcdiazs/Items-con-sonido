...
private:
    ...
    std::shared_ptr<Sound> itemDoorSound = nullptr;
    ...
    std::shared_ptr<Sound> itemRayoSound = nullptr;                 
    ...
    std::shared_ptr<Sprite> doorItemV = nullptr;                         
    std::shared_ptr<Sprite> doorItemAV = nullptr;                         
    std::shared_ptr<Sprite> doorItemT = nullptr;                         
    std::shared_ptr<Sprite> doorItemAT = nullptr;                          
    std::shared_ptr<Sprite> doorItemTort = nullptr;                          
